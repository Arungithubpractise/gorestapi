...
@Given("create a playlist with {string}")
public void create_a_playlist_with(String string) throws IOException 
{
res = given().log().all().spec(createplaylist()).body(Testdatabuild.playlistbody()); // .auth().oauth2(accesstoken);
}
//
//
